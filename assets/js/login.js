		...
		if ($.validator) {
			$('.login-form').validate({
				invalidHandler: function (event, validator) { // display error alert on form submit
					console.log('inside invalidHandler........', event);
					console.log('inside validator........', validator);
				...
				submitHandler: function (form) {
					...
					if (username == "") {
						alert("Oopss!!! Please enter username");
						return;
					}
					if (password == "") {
						alert("Oopss!!! Please enter password");
						return;
					}
					var finalData = {
						username: username,
					...
					NProgress.start();
					jQuery.post("helper/login_helper.php", finalData, function (data, textStatus) {
						NProgress.done();
						console.log(data);
