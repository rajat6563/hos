			...
			<div class="container">
				...
				<div class="crumbs">
					...
					<ul class="crumb-buttons">
						...
						<li class="dropdown"><a href="#" title="" data-toggle="dropdown"><i
									class="icon-tasks"></i><span>Users <strong>(+3)</strong></span><i
									class="icon-angle-down left-padding"></i></a>
							<ul class="dropdown-menu pull-right">
								<li><a href="form_components.html" title=""><i class="icon-plus"></i>Add new User</a>
								</li>
				...
				<div class="page-header">
					<div class="page-title">
						<h3>Dashboard</h3>
						<span>Hello, <?php echo var_dump($_SESSION['user_details']) ?>!</span>
					</div>
												...
												<ul class="feeds clearfix">
													...
													<li>
														<div class="col1">
															<div class="content">
																...
																<div class="content-col2">
																	<div class="desc">High CPU load on cluster #2. <span
																			class="label label-danger label-mini">Fix it
																			<i class="icon-share-alt"></i></span></div>
																</div>
															</div>
														</div> <!-- /.col1 -->
														<div class="col2">
													...
													<li>
														<div class="col1">
															<div class="content">
																<div class="content-col1">
																	<div class="label label-default"><i
																			class="icon-time"></i></div>
																</div>
																<div class="content-col2">
